...
# installation file
sudo wget https://raw.githubusercontent.com/Incrisz/Linux-commands/main/setup/nginx/install-nginx.sh
...
# sudo wget https://raw.githubusercontent.com/Incrisz/Linux-commands/main/setup/nginx/pull-nginx.sh
